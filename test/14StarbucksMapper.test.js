...
// ---------------------------------------------------------------------------
MapperTester = class MapperTester extends AvaTester {
...
tester.equal(62, `script:startup
	x = 23
	parse(this)
footer the end`, {
  type: 'tag',
...
tester.equal(81, `script:onmount
	x = 23
	parse(this)
footer the end`, {
  type: 'tag',
...
tester.equal(97, `script:ondestroy
	x = 23
	parse(this)
footer the end`, {
  type: 'tag',
