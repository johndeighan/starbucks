...
import {
  StarbucksMapper
} from '@jdeighan/starbucks/mapper';
...
export var starbucks = function({content, filename}, hOptions = {}) {
  var code, fileKind, hHooks, lPageParms, mapper, oOutput, tree, walker;
  ...
  hHooks = {
    ...
    start_tag: function(hTag, level) {
      var hAttr, hValue, key, quote, str, value;
      ({tag, hAttr} = hTag);
      if (isEmpty(hAttr)) {
