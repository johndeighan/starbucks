...
export var starbucks = function({content, filename}, hOptions = {}) {
  var code, dumping, dumppath, e, fileKind, fname, hCallbacks, hFileInfo, lPageParms, name, oOutput, parser, patchCallback, ref, value;
  // --- Valid options:
  //        dumpDir
  ...
  hCallbacks = {
    header: function(kind, lParms, optionstr) {
      var _, i, j, k, lMatches, len, len1, len2, opt, parm, path, ref1, ref2, str, stub;
      fileKind = kind;
